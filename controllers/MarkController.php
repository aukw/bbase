...
class MarkController extends BaseController
{
	...
	public function store($targettype, $targetid)
	{
            ...
            if($check){
                return $this->go('mark ok', $check);
            }else{
                return $this->warn('mark faild');
            }
	}
        ...
        private function addLike($targettype, $targetid)
        {
            ...
            $row = $this->markmodel->insert($like);
            if($row){
                $like['id'] = $row;
        ...
        private function delLike($likeid)
        {
            ...
            $del = $this->markmodel->delete(array('and' => $where));
            return $del;
        }
        ...
        private function getLikeStatus($targettype, $targetid)
        {
            ...
            $like = $this->markmodel->getEntity(array('AND'=>$where));
