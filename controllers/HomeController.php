	...
	public function __construct() {
        ...
        public function api()
        {
            ...
            $apilist = array(
                ...
                array('name' => '所有活动列表','module' => 'eventlist'),
                array('name' => '我的活动列表','module' => 'myeventlist'),
                array('name' => '他人活动列表','module' => 'youreventlist'),
                array('name' => '加入活动','module' => 'eventjoin'),
                array('name' => '退出活动','module' => 'eventquit'),
                array('name' => '评论/留言','module' => 'comment'),
                array('name' => '评论/留言列表','module' => 'commentlist'),
                array('name' => '删除评论','module' => 'commentdelete'),
                array('name' => '粉丝列表','module' => 'fanlist'),
                array('name' => '关注列表【废弃】','module' => 'followlist'),
                array('name' => '关注他人【废弃】','module' => 'follow'),
                array('name' => '删除关注【废弃】','module' => 'followdelete'),
                array('name' => '关注活动/删除关注','module' => 'mark'),
                array('name' => '关注活动列表','module' => 'marklist'),
